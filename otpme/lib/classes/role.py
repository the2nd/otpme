...
def register_oid():
    ...
    role_oid_re = (f'role[|]{realm_name_re}[/]{site_name_re}'
                f'([/]{unit_name_re})*[/]{role_name_re}')
...
class Role(OTPmeObject):
    ...
    def rename(
        ...
        **kwargs,
        ...
        msg = _("Rename role '{role_name}' to '{new_name}'?: ")
        msg = msg.format(role_name=self.name, new_name=new_name)
