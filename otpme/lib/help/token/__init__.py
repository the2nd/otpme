...
cmd_help = {
    ...
    'get_config'    : {
                    '_cmd_usage_help' : _('Usage: otpme-token get_config {token} {parameter}'),
    ...
    'changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-token changelog {token}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'edit_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-token edit_changelog {token} {entry_id} {comment}'),
    ...
    'del_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-token del_changelog {token} {entry_id}'),
                    'cmd'   :   '<|object|> <entry_id>',
                    '_help' :   {
    ...
    'clear_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-token clear_changelog {token}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'disable'    : {
                    '_cmd_usage_help' : _('Usage: otpme-token disable [--share-notify] [--no-share-notify] [--no-persist-mount] {token}'),
                    'cmd'   :   '--share-notify :share_notifications=True: --no-share-notify :share_notifications=False: --no-persist-mount :persist_mount=False: <|object|>',
                    '_help' :   {
                                    'cmd'                   : _('Disable token.'),
    ...
    'remove_dynamic_group'   : {
     ...
     'config'    : {
                    '_cmd_usage_help' : _('Usage: otpme-token config -d -a {token} {param} [value]'),
    ...
    'info'    : {
                    ...
                    '_help' :   {
                                    'cmd'                   : _('Set token info'),
                                    '--language <lang>'     : _('Change info for language.'),
                                },
                },

    'dump_info'    : {
                    '_cmd_usage_help' : _('Usage: otpme-token dump_info {token}'),
                    'cmd'   :   '--language :language: <|object|>',
                    '_help' :   {
                                    'cmd'                   : _('Dump token info'),
