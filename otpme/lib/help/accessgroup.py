...
cmd_help = {
    ...
    'del'    : {
                    '_cmd_usage_help' : _('Usage: otpme-accessgroup del [--no-trash] {accessgroup}'),
    ...
    'get_config'    : {
                    '_cmd_usage_help' : _('Usage: otpme-accessgroup get_config {accessgroup} {parameter}'),
    ...
    'changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-accessgroup changelog {accessgroup}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'edit_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-accessgroup edit_changelog {accessgroup} {entry_id} {comment}'),
    ...
    'del_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-accessgroup del_changelog {accessgroup} {entry_id}'),
                    'cmd'   :   '<|object|> <entry_id>',
                    '_help' :   {
    ...
    'clear_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-accessgroup clear_changelog {accessgroup}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'rename'    : {
     ...
     'config'    : {
                    '_cmd_usage_help' : _('Usage: otpme-accessgroup config -d -a {accessgroup} {param} [value]'),
    ...
    'show_config'      : {
                    '_cmd_usage_help' : _('Usage: otpme-accessgroup show_config {accessgroup} [parameter]'),
                    'cmd'   :   '<|object|> [parameter]',
                    '_help' :   {
    ...
    'add_token'   : {
                    '_cmd_usage_help' : _('Usage: otpme-accessgroup add_token [--skip-portal-token] {accessgroup} {token} [token_options]'),
    ...
    'remove_token'   : {
                    '_cmd_usage_help' : _('Usage: otpme-accessgroup remove_token [--skip-portal-token] {accessgroup} {token}'),
