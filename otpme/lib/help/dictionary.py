...
cmd_help = {
    ...
    'del'    : {
                    '_cmd_usage_help' : _('Usage: otpme-dictionary del [--no-trash] {dict_name}'),
    ...
    'changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-dictionary changelog {dictionary}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'edit_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-dictionary edit_changelog {dictionary} {entry_id} {comment}'),
    ...
    'del_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-dictionary del_changelog {dictionary} {entry_id}'),
                    'cmd'   :   '<|object|> <entry_id>',
                    '_help' :   {
    ...
    'clear_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-dictionary clear_changelog {dictionary}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'info'    : {
                    '_cmd_usage_help' : _('Usage: otpme-dictionary info {dict_name} [info]'),
                    'cmd'   :   '--language :language: <|object|> [info]',
                    '_help' :   {
                                    'cmd'                   : _('Set dictionary info'),
                                    '--language <lang>'     : _('Change info for language.'),
                                },
                },

    'dump_info'    : {
                    '_cmd_usage_help' : _('Usage: otpme-dictionary dump_info {dict_name}'),
                    'cmd'   :   '--language :language: <|object|>',
                    '_help' :   {
                                    'cmd'                   : _('Dump dictionary info'),
