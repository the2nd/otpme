...
cmd_help = {
    ...
    'del'    : {
                    '_cmd_usage_help' : _('Usage: otpme-scope del [--no-trash] {scope}'),
    ...
    'changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-scope changelog {scope}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'edit_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-scope edit_changelog {scope} {entry_id} {comment}'),
    ...
    'del_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-scope del_changelog {scope} {entry_id}'),
                    'cmd'   :   '<|object|> <entry_id>',
                    '_help' :   {
    ...
    'clear_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-scope clear_changelog {scope}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
