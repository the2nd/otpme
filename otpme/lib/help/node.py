...
cmd_help = {
    ...
    'del'    : {
                    '_cmd_usage_help' : _('Usage: otpme-node del [--no-trash] {node}'),
    ...
    'get_config'    : {
                    '_cmd_usage_help' : _('Usage: otpme-node get_config {node} {parameter}'),
    ...
    'changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-node changelog {node}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'edit_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-node edit_changelog {node} {entry_id} {comment}'),
    ...
    'del_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-node del_changelog {node} {entry_id}'),
                    'cmd'   :   '<|object|> <entry_id>',
                    '_help' :   {
    ...
    'clear_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-node clear_changelog {node}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'info'    : {
                    '_cmd_usage_help' : _('Usage: otpme-node info {node} [info]'),
    ...
    'dump_info'    : {
                    '_cmd_usage_help' : _('Usage: otpme-node dump_info {node}'),
                    'cmd'   :   '--language :language: <|object|>',
                    '_help' :   {
                                    'cmd'                   : _('Dump node info'),
