...
cmd_help = {
    ...
    'del'    : {
                    '_cmd_usage_help' : _('Usage: otpme-pool del [--no-trash] {pool}'),
    ...
    'get_config'    : {
                    '_cmd_usage_help' : _('Usage: otpme-pool get_config {pool} {parameter}'),
    ...
    'changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-pool changelog {pool}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'edit_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-pool edit_changelog {pool} {entry_id} {comment}'),
    ...
    'del_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-pool del_changelog {pool} {entry_id}'),
                    'cmd'   :   '<|object|> <entry_id>',
                    '_help' :   {
    ...
    'clear_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-pool clear_changelog {pool}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'info'    : {
                    '_cmd_usage_help' : _('Usage: otpme-pool info {pool} [info]'),
    ...
    'dump_info'    : {
                    '_cmd_usage_help' : _('Usage: otpme-pool dump_info {pool}'),
                    'cmd'   :   '--language :language: <|object|>',
                    '_help' :   {
                                    'cmd'                   : _('Dump pool info'),
