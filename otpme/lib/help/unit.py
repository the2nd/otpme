...
cmd_help = {
    ...
    'get_config'    : {
                    '_cmd_usage_help' : _('Usage: otpme-unit get_config {unit} {parameter}'),
                    'cmd'   :   '<|object|> <parameter>',
                    '_help' :   {
    ...
    'changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-unit changelog {unit}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'edit_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-unit edit_changelog {unit} {entry_id} {comment}'),
    ...
    'del_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-unit del_changelog {unit} {entry_id}'),
                    'cmd'   :   '<|object|> <entry_id>',
                    '_help' :   {
    ...
    'clear_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-unit clear_changelog {unit}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'rename'    : {
     ...
     'config'    : {
                    '_cmd_usage_help' : _('Usage: otpme-unit config -d -a {unit} {param} [value]'),
    ...
    'info'    : {
                    '_cmd_usage_help' : _('Usage: otpme-unit info {unit} [info]'),
    ...
    'dump_info'    : {
                    '_cmd_usage_help' : _('Usage: otpme-unit dump_info {unit}'),
                    'cmd'   :   '--language :language: <|object|>',
                    '_help' :   {
                                    'cmd'                   : _('Dump unit info'),
