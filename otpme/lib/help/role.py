...
cmd_help = {
    ...
    'del'    : {
                    '_cmd_usage_help' : _('Usage: otpme-role del [--no-trash] {role}'),
    ...
    'changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-role changelog {role}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
    ...
    'edit_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-role edit_changelog {role} {entry_id} {comment}'),
    ...
    'del_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-role del_changelog {role} {entry_id}'),
                    'cmd'   :   '<|object|> <entry_id>',
                    '_help' :   {
    ...
    'clear_changelog'    : {
                    '_cmd_usage_help' : _('Usage: otpme-role clear_changelog {role}'),
                    'cmd'   :   '<|object|>',
                    '_help' :   {
