...
def register_policy_object():
    ...
    for object_type in config.tree_object_types:
        module_path = f"otpme.lib.classes.{object_type}"
...
class DefaultunitsPolicy(Policy):
    ...
    def remove_orphans(
        ...
        **kwargs,
        ...
        """ Remove orphan UUIDs. """
        extra_ref_lists = [
                ('default_units', 'unit', None, 'dict_values'),
                ]
    ...
    def set_default_unit(self, object_type, unit_path=None, run_policies=True,
        ...
        if unit_path is None:
            ...
            if unit_uuid == default_unit:
                msg = _("Unit already set for this policy.")
                return callback.error(msg)
    ...
    def show_config(self, callback=default_callback, **kwargs):
        ...
        lines.append(f'DEFAULT_UNITS="{default_units}"')
