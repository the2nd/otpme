...
class DefaultrolesPolicy(Policy):
                ...
                if result:
                    ...
                    for role_uuid in self.default_roles:
                        ...
                        try:
                            ...
                            msg = _("Failed to add default token to role: {}: {}, {}")
                            msg = msg.format(role.name, default_token, e)
    ...
    def show_config(self, callback=default_callback, **kwargs):
        ...
        or self.verify_acl("remove:default_role"):
            ...
            roles_string = f"{','.join(defaultroles)}"
            default_roles.append(roles_string)
        lines.append(f'DEFAULT_ROLES="{",".join(default_roles)}"')
