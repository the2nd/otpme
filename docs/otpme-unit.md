...
:   Move unit to a different unit. Use **-m** to merge objects into destination, **-k** to keep source unit.
...
:   Show LDIF representation of the unit. Use **-a** to show only specific attributes.
