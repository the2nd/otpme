...
**otpme-pool** *command* \[*options*\] \[*pool*\]

# DESCRIPTION

**otpme-pool** manages node pools in the OTPme system. A pool defines
which nodes are used for a share.
...
**otpme**(1), **otpme**(7), **otpme-share**(1), **otpme-node**(1)
